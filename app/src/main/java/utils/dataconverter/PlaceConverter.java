...
public class PlaceConverter {
    ...
    public static String getTrashcanAddress(Context context) {
        ...
        if(TrashcanLocation.getLocation() != null) {
            try {
                List<Address> addresses = geocoder.getFromLocation(TrashcanLocation.getLocation().getLatitude(), TrashcanLocation.getLocation().getLongitude(), 1); // Here 1 represent max location result to returned, by documents it recommended 1 to 5
